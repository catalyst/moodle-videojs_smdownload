 ...
 */
 ...
 // Default options for the plugin.
    ...
    class DownloadButton extends vjsButton {
      ...
      */
      buildCSSClass() {
        return `vjs-vjssmdownload ${super.buildCSSClass()}`;
      }
      ...
      */
      handleClick() {
        ...
        window.open(this.options_.smdownloadURL || p.currentSrc(), 'Download');
        p.trigger('smdownloadvideo');
      }
    ...
    const onPlayerReady = (player, options) => {
      ...
      player.addClass('vjs-vjssmdownload');
    };
     ...
     *
     * @function vjssmdownload
     * @param    {Object} [options={}]
     *           An object of options left to the plugin author to define.
     */
    const vjssmdownload = function(options) {
      this.ready(() => {
    ...
    videojs.registerPlugin('smdownload', vjssmdownload);

/*
 * END NATIVE PLUGIN CODE.
 */

   return vjssmdownload;
